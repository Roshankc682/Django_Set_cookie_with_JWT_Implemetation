...
urlpatterns = [
    ...
    path('api/token/new/', views.user_new_access_and_refrsh_token_and.as_view(), name='Token_refresh_of_reflecting_acces_token'),
    path('api/access/refresh/', TokenRefreshView.as_view(), name='Get_access_if_page_refresh'),
    path('api/logout', views.logout, name='Logout'),
    path('api/dashboard/', views.get_data_of_user.as_view(), name='Token_create'),
]